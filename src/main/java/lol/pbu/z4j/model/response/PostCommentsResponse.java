...
import lol.pbu.z4j.model.PostComment;
...
public class PostCommentsResponse {
     ...
     */
    public List<@Valid PostComment> getComments() {
        return comments;
    }
     ...
     */
    public void setComments(List<@Valid PostComment> comments) {
     ...
     */
    public PostCommentsResponse comments(List<@Valid PostComment> comments) {
        this.comments = comments;
        return this;
    }
