...
public interface UserSegmentsClient {
     ...
     */
    @Post("/help_center/user_segments")
     ...
     */
    @Delete("/help_center/user_segments/{userSegmentID}")
     ...
     */
    @Get("/help_center/user_segments/{userSegmentID}/sections")
     ...
     * @return OK Response (status code 200)
     */
    @Get("/help_center/user_segments/{userSegmentID}/topics")
     ...
     * Suite plan, use the {@code /help_center/user_segments/applicable.json} endpoint.
     * The {@code /help_center/users/{user_id}/user_segments.json} endpoint returns the list of user segments
     ...
     * @return OK Response (status code 200)
     */
    @Get("/help_center/user_segments/{userSegmentID}")
     ...
     * or Bad request Response (status code 400)
     */
    @Put("/help_center/user_segments/{userSegmentID}")
    @Header(name = CONTENT_TYPE, value = APPLICATION_JSON)
